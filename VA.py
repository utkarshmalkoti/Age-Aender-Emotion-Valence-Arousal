...
def neural_net():
    ...
    earlystop = tensorflow.keras.callbacks.EarlyStopping(monitor='val_loss',min_delta=0.0001,patience=5,mode='min',restore_best_weights=True,verbose=1)
    ...
    model.fit(x_train,y_train,batch_size=32,epochs=100,validation_data=(x_test,y_test),callbacks=[chkpoint,lr,earlystop])
neural_net()
